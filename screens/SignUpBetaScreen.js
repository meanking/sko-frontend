...
class SignUpBetaScreen extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { username: "", password: "", phoneNumber: "", betaKey: "" };
  }
  ...
  doSignUp = () => {
    ...
    const { username, password, phoneNumber, betaKey } = this.state;
        ...
        <View style={styles.container}>
          ...
          <View style={styles.fieldsContainer}>
            ...
            <TextInput
              ...
              accessibilityLabel="BetaKey"
              onChangeText={(text) => this.setState({ betaKey: text })}
            />
